    ...
    public static class MGLStyleLoader
    {
        ...
        public static MGLStyleFile Load(Stream input)
        {
            ...
            using (var reader = new StreamReader(input))
                jsonStyle = JsonConvert.DeserializeObject<StyleFile>(reader.ReadToEnd());
        ...
        private static void ExtractSprites(StyleFile jsonStyle, MGLSpriteAtlas spriteAtlas)
        {
        ...
        private static void ExtractGlyphs(StyleFile jsonStyle, object glyphAtlas)
        {
        ...
        /// </summary>
        private static List<IDrawableTileSource> ExtractSources(StyleFile jsonStyle, Dictionary<string, Source> sources, MGLSpriteAtlas spriteAtlas)
        {
        ...
        private static IDrawableTileSource CreateBackgroundTileSource(IEnumerable<StyleLayer> styleLayers, MGLSpriteAtlas spriteAtlas)
        {
        ...
        private static MGLRasterTileSource CreateRasterTileSource(StyleFile jsonStyle, string name, Source source, MGLSpriteAtlas spriteAtlas)
        {
        ...
        private static IDrawableTileSource CreateVectorTileSource(StyleFile jsonStyle, string name, Source source, MGLSpriteAtlas spriteAtlas)
        {
            ...
            if (!string.IsNullOrEmpty(source.Url))
            {
                ...
                else if (source.Url.StartsWith("mbtiles"))
                {
                    ...
                    jsonSource = JsonConvert.DeserializeObject<Source>(dataSource.Json);
                    jsonSource.Name = name;
        ...
        /// <returns></returns>
        private static ITileSource CreateTileSource(Source source)
        {
